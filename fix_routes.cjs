...
fs.writeFileSync('src/routes/dispatch.js', dispatch, 'utf8');
console.log('dispatch.js written (' + dispatch.length + ' chars)');
...
fs.writeFileSync('src/routes/index.js', indexJs, 'utf8');
